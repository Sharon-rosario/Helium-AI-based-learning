...
//   const host = "http://localhost:8000";
  ...
  const paymentCCAvenue = () => {
    let paymentData = {
      ...
      redirect_url: `${host}/books/on-successfull-transaction`, // Success URL (Required)
      cancel_url: `${host}/books/on-successfull-transaction`, // Failed/Cancel Payment URL (Required)
      language: "EN",
      billing_tel: searchParams.get("billing_tel"),
      merchant_param1: searchParams.get("bookId"),
      merchant_param2: searchParams.get("userId"),
      merchant_param3: searchParams.get("batchId"),
      merchant_param4: searchParams.get("modifiedFields"),
      // merchant_param4: searchParams.get("walletPointUsed"),
      // merchant_param5: searchParams.get("DiscountUsed"),
      merchant_param5: searchParams.get("Address")
    };
