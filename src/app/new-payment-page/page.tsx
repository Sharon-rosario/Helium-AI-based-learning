...
export default function Payment() {
  ...
  const paymentCCAvenue = () => {
    let paymentData = {
      ...
      redirect_url: `${host}/users/on-new-successfull-transaction`, // Success URL (Required)
      cancel_url: `${host}/users/on-new-successfull-transaction`, // Failed/Cancel Payment URL (Required)
      language: "EN",
