            ...
            <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
              <div className="copyright-text border-line">
                <p className='flex flex-col'>
                  <span>© 2024  Helium Edu Research Pvt. Ltd.</span>
                </p>
              </div>
            </div>
            <div className="col-xl-4 col-lg-4 col-sm-6">
              <div className="copy-right-support border-line-2">
                ...
                <div className='flex flex-col flex-wrap'>
                  <span className='text-[30px]'>Connect Now</span>
                  <span>+91 98897 63777</span>
                  <span className='text-lg text-blue-500'>connect@heliumlearn.com</span>
                </div>
              </div>
            </div>
